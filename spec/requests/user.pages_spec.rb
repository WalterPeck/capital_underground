...
###################################### BUYING DRUGS ####################################################	  
  ...
  ###################################### WEED ####################################################	
     ...
     describe "weed and" do  #This makes the whole test read more like english when there is an error
  		...
  		it "SHOULD add oz to the WEED attribute" do
    	...
    	it "should NOT add oz to the user and SHOULD show Flash Error" do
...
###################################### SHROOMS ####################################################	
    ...
    describe "shrooms and"  do
      ...
      it "SHOULD add oz to the user" do
...
###################################### MOLLY ####################################################	  		
  	...
  	describe "molly and" do	
  		...
  		it "should add oz to the MOLLY attribute" do
     		select '1 oz', from: 'user_molly'	
      ...
      it "should NOT add oz to the MOLLY attribute and show Flash Error" do
...
#		These have to be Failing Tests.. do not have enough money to purchase these more expensive  					  		 
 ################################################################################################      
    ...
    describe "cocaine and" do  
      ...
      it "should not add oz to the Cocaine attribute and should flash" do
    ...
    describe "meth and" do  
      it "should not add oz to the METH attribute" do
    ...
    describe "oxycontin and" do  
      it "should not add oz to the Oxycontin attribute" do
